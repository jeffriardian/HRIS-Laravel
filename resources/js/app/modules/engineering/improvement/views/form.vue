<template>
    <div>
        <div class="form-group" :class="{ 'has-error': errors.employee_id }">
            ...
            <v-select v-model="form.employee_id" :options="employees.data" label="name" :reduce="name => name.id" :class="{ 'border-danger': errors.employee_id }">
            </v-select>
...
export default {
    ...
    methods: {
        ...
        ...mapMutations('improvement', ['CLEAR_FORM']), //PANGGIL MUTATIONS CLEAR_FORM
