<template>
    <div>
        ...
        <div class="form-group" :class="{ 'has-error': errors.part }">
            <label for="">{{ $tc('part') }}</label>
            <input type="text" class="form-control" :class="{ 'border-danger': errors.part }" v-model="form.part">
            <p class="text-danger" v-if="errors.part">{{ errors.part[0] }}</p>
        </div>
        <div class="form-group" :class="{ 'has-error': errors.description }">
            ...
            <small class="text-muted">write the chronology of the failure here</small>
        </div>
...
export default {
    ...
    methods: {
        ...
        ...mapMutations('failureAnalysis', ['CLEAR_FORM']), //PANGGIL MUTATIONS CLEAR_FORM
