...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: 'physicalAvailability', label: 'physical availability', thStyle: 'text-align: center; width: 180px;',tdClass: 'text-center'},
            ],
            keyword:'',
            modelId:null,
    ...
    methods: {
        ...
        ...mapActions('report', {load:'physicalAvailability'}),
        getPhysicalAvailability(jobCards){
            var duration = 0;
        ...
        exportFile(type) {
            window.open(`/api/engineering/reports/physical-availability-export-${type}?api_token=${this.$store.state.token}`)
        },
    }
}
</script>