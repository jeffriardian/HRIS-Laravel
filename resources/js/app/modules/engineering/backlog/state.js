...
function defaultForm() {
    return {
        ...
        machine_id: '',
        failure_type_id: '',
        estimation_repair_time: '',
        estimation_endurance_time: '',
        description: '',
        is_active: false,
        created_by: '', 
        updated_by: '', 
...
const mutations = {
    ...
    ASSIGN_FORM(state, payload) {
        state.form = {
            ...
            failure_type_id: payload.failure_type_id,
            estimation_repair_time: payload.estimation_repair_time,
            estimation_endurance_time: payload.estimation_endurance_time,
...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/engineering/backlogs`,{ params: payload })
            .then((response) => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/engineering/backlog-list`)
            .then((response) => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios.post(`/engineering/backlogs`, state.form)
            .then((response) => {
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/engineering/backlogs/${payload}`)
            .then((response) => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios.put(`/engineering/backlogs/${payload}`, state.form)
            .then((response) => {
                //FORM DIBERSIHKAN
                commit('CLEAR_FORM')
                resolve(response.data)
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.delete(`/engineering/backlogs/${payload}`)
            .then((response) => {
