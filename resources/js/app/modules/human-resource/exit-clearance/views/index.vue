<template>
  <div class="card">
    ...
    <b-modal id="form-modal" :title="$t('form module',{module:$tc('exit clearance')})" ref="modal">
      <form v-on:submit.prevent="submit">
        <formComponent
          :modelId="modelId"
          @check-exit-clearance="getTotalCheckClearance"
          @process-checking="getIsChecked"
        ></formComponent>
      </form>
      <template v-slot:modal-footer>
        ...
        <button
          ...
          :disabled="totalCheckExitClearance < 2"
        >
...
export default {
  ...
  data() {
    return {
      fields: [
        ...
        {
          key: "exit_clearance_number",
          label: "exit clearance number",
          sortable: true,
        },
        {
          key: "is_active",
  ...
  computed: {
    ...
    tableParams: {
      get() {
        ...
        return this.$store.state.humanResource.exitClearance.tableParams;
      },
      set(params) {
        this.$store.commit(
          "humanResource/exitClearance/SET_TABLE_PARAMS",
          params
        );
      },
    },
  ...
  methods: {
    ...
    getTotalCheckClearance(value) {
      this.totalCheckExitClearance = value;
    },
    getIsChecked(value) {
