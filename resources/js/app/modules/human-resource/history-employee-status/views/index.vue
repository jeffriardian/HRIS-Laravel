...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: 'contract', label: 'Status', sortable: true },
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.historyEmployeeStatus.tableParams
            },
            set(params) {
                this.$store.commit('humanResource/historyEmployeeStatus/SET_TABLE_PARAMS', params)
            }
        },
    },
    watch: {
    ...
    methods: {
        ...
        ...mapActions('historyEmployeeStatus', ['load','show', 'store', 'update', 'destroy']),
        hideModal(){
