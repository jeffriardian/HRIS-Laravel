<template>
    <div>
        ...
        <div class="form-group" :class="{ 'has-error': errors.total }">
            ...
            <input type="text" class="form-control" :class="{ 'border-danger': errors.total }" v-model="form.total">
...
export default {
    ...
    methods: {
        ...
        ...mapMutations('leaveCategory', ['CLEAR_FORM']), //PANGGIL MUTATIONS CLEAR_FORM
    },
