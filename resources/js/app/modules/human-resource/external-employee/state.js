...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/external-employees`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/external-employee-list`, {
                    params: payload
                })
                .then(response => {
                    //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/human-resource/external-employees`, state.form)
                .then(response => {
                    ...
                    dispatch("loadList", state.tableParams).then(() => {
                        resolve(response.data);
                    });
                })
                .catch(error => {
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/human-resource/external-employees/${payload}`)
                .then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .put(
                    `/human-resource/external-employees/${payload}`,
                    state.form
                )
                .then(response => {
                    //FORM DIBERSIHKAN
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/human-resource/external-employees/${payload}`)
                .then(response => {
