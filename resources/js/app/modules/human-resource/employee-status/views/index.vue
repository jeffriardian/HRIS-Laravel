...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: 'contract', label: 'Name', sortable: true },
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.employeeStatus.tableParams
            },
            set(params) {
                this.$store.commit('humanResource/employeeStatus/SET_TABLE_PARAMS', params)
            }
        },
    },
    watch: {
    ...
    methods: {
        ...
        ...mapActions('employeeStatus', ['load','show', 'store', 'update', 'destroy']),
        hideModal(){
