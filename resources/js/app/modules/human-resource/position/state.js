...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/positions`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/human-resource/position-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    //TAMPIL DATA POSISI DAN DEPARTMENT
    loadListPositionGroup({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/human-resource/position-group-list`).then(response => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
                commit("ASSIGN_LIST", response.data);
                resolve(response.data);
            });
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/human-resource/positions`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/human-resource/positions/${payload}`)
                .then(response => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/human-resource/positions/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/human-resource/positions/${payload}`)
                .then(response => {
