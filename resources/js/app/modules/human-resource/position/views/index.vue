<template>
    <div class="card">
        ...
        <b-modal
            id="form-modal"
            :title="$t('form module', { module: $tc('position') })"
            ref="modal"
        >
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.position.tableParams;
            },
            set(params) {
                this.$store.commit(
                    "humanResource/position/SET_TABLE_PARAMS",
                    params
                );
            }
        }
