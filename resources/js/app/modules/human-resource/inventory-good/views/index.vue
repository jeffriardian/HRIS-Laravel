...
export default {
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.inventoryGood.tableParams
            },
            set(params) {
                this.$store.commit('humanResource/inventoryGood/SET_TABLE_PARAMS', params)
            }
        },
    },
    watch: {
    ...
    methods: {
        ...
        ...mapActions('inventoryGood', ['load','show', 'update', 'destroy']),
        hideModal(){
