<template>
    <div class="card">
        ...
        <b-modal
            id="form-modal"
            :title="$t('form module', { module: $tc('Incident Penalty') })"
            ref="modal"
        >
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.incidentPenalty
                    .tableParams;
            },
            set(params) {
                this.$store.commit(
                    "humanResource/incidentPenalty/SET_TABLE_PARAMS",
                    params
                );
            }
        }
                ...
                this.store().then(() => {
                    ...
                    this.$message({
                        ...
                        message: this.$t("present perfect", {
                            object: this.$tc("Incident Penalty"),
        ...
        remove(item) {
            this.$confirm(
                this.$t("delete confirmation", {
                    item: item.name,
                    module: this.$tc("Incident Penalty")
                }),
                this.$t("warning"),
                {
