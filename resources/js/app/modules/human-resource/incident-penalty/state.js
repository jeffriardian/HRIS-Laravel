...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/incident-penalties`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/incident-penalty-list`)
                .then(response => {
                    //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/human-resource/incident-penalties`, state.form)
                .then(response => {
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/human-resource/incident-penalties/${payload}`)
                .then(response => {
    ...
    showInterrogation({ commit }, payload) {
        ...
        return new Promise((resolve, reject) => {
            //MELAKUKAN REQUEST DENGAN MENGIRIMKAN ID DI URL
            $axios
                .get(`/human-resource/penalty-interrogation/${payload}`)
                .then(response => {
                    //APABIL BERHASIL, DI ASSIGN KE FORM
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .put(
                    `/human-resource/incident-penalties/${payload}`,
                    state.form
                )
                .then(response => {
                    //FORM DIBERSIHKAN
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/human-resource/incident-penalties/${payload}`)
                .then(response => {
