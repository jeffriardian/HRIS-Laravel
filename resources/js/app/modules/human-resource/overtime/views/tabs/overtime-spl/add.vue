<template>
  <div class="card">
    <div class="card-header">
      <h5 class="card-title">{{ $tc("create") }} {{ $tc("overtime") }}</h5>
    </div>
    <div class="card-body">
      <formComponent></formComponent>
    </div>
    <div
      class="card-footer bg-white d-sm-flex justify-content-sm-between align-items-sm-center"
    >
...
export default {
  ...
  methods: {
    ...mapActions("overtime", ["store"]), //PANGGIL ACTIONS store
    submit() {
