...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/human-resource/schedule-recruitments`,{ params: payload })
            .then((response) => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios.get(`/human-resource/schedule-recruitment-list`)
            .then((response) => {
                //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios.post(`/human-resource/schedule-recruitments`, state.form)
            .then((response) => {
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.get(`/human-resource/schedule-recruitments/${payload}`)
            .then((response) => {
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios.put(`/human-resource/schedule-recruitments/${payload}`, state.form)
            .then((response) => {
                //FORM DIBERSIHKAN
                commit('CLEAR_FORM')
                resolve(response.data)
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios.delete(`/human-resource/schedule-recruitments/${payload}`)
            .then((response) => {
