...
export default {
    ...
    data() {
        return {
            fields: [
                ...
                { key: 'inventory', label: 'Inventory', thStyle: 'text-align: center; width: 150px;', sortable: true, tdClass: 'text-center'},
                { key: 'type', label: 'Type', thStyle: 'text-align: center; width: 150px;', sortable: true, tdClass: 'text-center'},
    ...
    computed: {
        ...
        tableParams: {
            get() {
                ...
                return this.$store.state.humanResource.inventoryEmployee.tableParams
            },
            set(params) {
                this.$store.commit('humanResource/inventoryEmployee/SET_TABLE_PARAMS', params)
            }
        },
    },
    watch: {
    ...
    methods: {
        ...
        ...mapActions('inventoryEmployee', ['load','show', 'store', 'update', 'destroy']),
        hideModal(){
        ...
        remove(item) {
            this.$confirm(this.$t('delete confirmation',{item:item.id, module:this.$tc('Request Inventory')}), this.$t('warning'), {
