    <template>    
        <div>
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-row">
                                ...
                                >
                                    ...
                                    <textarea class="form-control" :class="{ 'border-danger': errors.address }"  v-model="form.address"></textarea>
                    ...
                    <div class="form-row">
                        ...
                        <div v-if="form.has_sim == 'Yes'" class="form-group col-md-3">
                                    ...
                                    <div class="card m-b-30">
                                        ...
                                        <div class="container">
                                            <div class="form-group col-md-12">
                                                ...
                                                <textarea class="form-control" v-model="form.achivement"></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Thesis Title</label> 
                                                <input type="text" class="form-control" v-model="form.thesis_title"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card m-b-30">
                                                ...
                                                >
                                                    ...
                                                    <td>
                                                        ...
                                                        placeholder="Select Date Range"
                                                         :disabled-date="disabledAfterToday"
                                                         :picked="getStartDate(index, row.range)"
                                                        ></date-picker>
                                                        <br />
                                                    </td>
                                                    <!-- <td>
                                                        <date-picker
                                                            ...
                                                            :pick="getStartDate(index, row.start_date)"
                                                            format="YYYY-MM-DD"
                                                            value-type="format"
                                                            type="date"
                                                            :disabled-date="disabledAfterToday"
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" v-model="form.last_facility"></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>Achivement During Work</label> 
                                                <textarea class="form-control" v-model="form.achivement_during_work"></textarea>
                                            </div>
                                            <div class="form-group col-md-12">
                                                <label>In Previous Job Desc</label> 
                                                <textarea class="form-control" v-model="form.last_job_desc"></textarea>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input
                                                            ...
                                                            v-model="form.expected_facilities"
                                                        />
                                    ...
                                    <div class="card m-b-30">
                                        ...
                                        <div class="container">
                                            <div class="form-row">
                                                ...
                                                <div v-if="form.work_accident == 'Yes'" class="form-group col-md-6">
                                                    <label>When</label> 
                                                    <date-picker
                                                        format="YYYY-MM-DD"
                                                        value-type="format"
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <b-form-checkbox
                                                        v-model="form.psychological_check"
                                                        id="checkbox-2"
                                                        name="checkbox-2"
                                                        value="Yes"
                                                        unchecked-value="No"
                                                    ...
                                                    <div v-if="form.psychological_check == 'Yes'" class="form-group col-md-3">
                                                        <label>When</label> 
                                                        <date-picker
                                                            format="YYYY-MM-DD"
                                                            value-type="format"
...
export default {
    ...
    methods: {
        ...
        getStartDate(index, date){
            // console.log(date);
            // console.log(date.['0']);
            console.log("Range", this.job_experiences[index].range);
                // this.job_experiences[index].start_date = date[0].getDate()
                // this.job_experiences[index].end_date = date[1].getDate();
                // console.log("Start", this.job_experiences[index].start_date);
                // console.log("End", this.job_experiences[index].end_date);
        },
        ...
        onComplete (e) {
                ...
                this.form.last_salary = maskRef.unmaskedValue;
                console.log('salary', this.form.last_salary);
        },
        onCompleteExpect (e) {
                const maskRef = e.detail;
                console.log('complete', maskRef.unmaskedValue);
                // console.log('dataForm',this.form);
                this.form.expected_salaries = maskRef.unmaskedValue;
