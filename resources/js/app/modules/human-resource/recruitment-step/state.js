...
const mutations = {
    ...
    ASSIGN_FORM(state, payload) {
        state.form = {
            ...
            parameters: payload.recruitment_step_parameter,
            min_score: payload.min_score,
            is_active: payload.is_active
        };
    },
    ASSIGN_RATING(state, payload) {
        state.ratingForm.score = payload;
        // state.ratingForm = {
        //     score_id: payload.score.score_id,
        // }
    },
...
const actions = {
    ...
    load({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/recruitment-steps`, { params: payload })
                .then(response => {
    ...
    loadList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/recruitment-step-list`)
                .then(response => {
                    //SIMPAN DATA KE STATE MELALUI MUTATIONS
    ...
    loadNextList({ commit }, payload) {
        return new Promise((resolve, reject) => {
            $axios
                .get(`/human-resource/recruitment-next-step-list/${payload}`)
                .then(response => {
                    //SIMPAN DATA KE STATE MELALUI MUTATIONS
                    commit("ASSIGN_LIST", response.data);
                    resolve(response.data);
    ...
    store({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            ...
            //DARI STATE FORM
            $axios
                .post(`/human-resource/recruitment-steps`, state.form)
                .then(response => {
    ...
    storeScore({ dispatch, commit, state }) {
        return new Promise((resolve, reject) => {
            //MENGIRIMKAN PERMINTAAN KE SERVER DAN MELAMPIRKAN DATA YANG AKAN DISIMPAN
            //DARI STATE FORM
            $axios
                .post(
                    `/human-resource/recruitment-step-parameter-scores`,
                    state.form
                )
                .then(response => {
                    //APABILA BERHASIL KITA MELAKUKAN REQUEST LAGI
    ...
    show({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(`/human-resource/recruitment-steps/${payload}`)
                .then(response => {
    ...
    showDetail({ commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .get(
                    `/human-resource/recruitment-step-parameter-scores-list/${payload}`
                )
                .then(response => {
                    //APABIL BERHASIL, DI ASSIGN KE FORM
                    commit("ASSIGN_RATING", response.data.data);
                    resolve(response.data);
                });
        });
    },
    ...
    update({ state, commit }, payload) {
        return new Promise((resolve, reject) => {
            ...
            //MELALUI STATE FORM
            $axios
                .put(`/human-resource/recruitment-steps/${payload}`, state.form)
                .then(response => {
                    //FORM DIBERSIHKAN
                    commit("CLEAR_FORM");
                    resolve(response.data);
    ...
    destroy({ dispatch, state }, payload) {
        return new Promise((resolve, reject) => {
            ...
            $axios
                .delete(`/human-resource/recruitment-steps/${payload}`)
                .then(response => {
