...
use Modules\HumanResource\Exports\DepartmentLevel as ModelExport;
...
class DepartmentLevelController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "department_level_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('humanresource::pdf.department-level', compact('models'));
        return $pdf->stream();
    }
