...
use Modules\HumanResource\Exports\BloodType as ModelExport;
...
class BloodTypeController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "blood_type_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('humanresource::pdf.blood-type', compact('models'));
        return $pdf->stream();
    }
