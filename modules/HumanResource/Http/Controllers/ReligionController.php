...
use Modules\HumanResource\Exports\Religion as ModelExport;
...
class ReligionController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "religion_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('humanresource::pdf.religion', compact('models'));
        return $pdf->stream();
    }
