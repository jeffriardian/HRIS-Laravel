...
class LeaveController extends Controller
{
    ...
    {
        $data = Model::select(['leaves.*', 'employees.name as name', 'leave_categories.name as leave'])
            ->join('employees', 'employees.id', '=', 'leaves.employee_id')
            ->join('leave_categories', 'leave_categories.id', '=', 'leaves.leave_category_id');
        ...
        if (request()->keyword != '') {
            $data = $data->where('employees.name', 'LIKE', '%' . request()->keyword . '%')
                        ->orWhere('leave_categories.name', 'LIKE', '%' . request()->keyword . '%');
        }
