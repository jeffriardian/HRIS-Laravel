...
use Modules\Production\Exports\MachineBrand as ModelExport;
...
class MachineBrandController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "machine_brand_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('production::pdf.machine-brand', compact('models'));
        return $pdf->stream();
    }
