...
use Modules\Production\Exports\MachineGroup as ModelExport;
...
class MachineGroupController extends Controller
{
    ...
    {
        $data = Model::with(['parts'])->orderBy('id', 'ASC');
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "machine_group_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('production::pdf.machine-group', compact('models'));
        return $pdf->stream();
    }
