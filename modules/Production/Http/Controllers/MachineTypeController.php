...
use Modules\Production\Exports\MachineType as ModelExport;
...
class MachineTypeController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "machine_type_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('production::pdf.machine-type', compact('models'));
        return $pdf->stream();
    }
