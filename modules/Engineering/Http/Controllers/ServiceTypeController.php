...
use Modules\Engineering\Exports\ServiceType as ModelExport;
...
class ServiceTypeController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "service_type_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('engineering::pdf.service-type', compact('models'));
        return $pdf->stream();
    }
