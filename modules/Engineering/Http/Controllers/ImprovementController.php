...
use Modules\Engineering\Models\EngineeringImprovement as Model;
use Modules\Engineering\Exports\EngineeringImprovement as ModelExport;
...
class ImprovementController extends Controller
{
    ...
    {
        $data = Model::with(['employee'])->orderBy('id', 'ASC');
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "engineering_improvement_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('engineering::pdf.engineering-improvement', compact('models'));
        return $pdf->stream();
    }
