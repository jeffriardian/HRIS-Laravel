...
use Modules\Engineering\Exports\FailureType as ModelExport;
...
class FailureTypeController extends Controller
{
    ...
    {
        $now = now();
        return Excel::download(new ModelExport, "failure_type_list_{$now}.xlsx");
    }
    ...
    public function exportPdf() 
    {
        ...
        $pdf = PDF::loadView('engineering::pdf.failure-type', compact('models'));
        return $pdf->stream();
    }
